...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="E:/ZY20210320/DSSD-master/configs/resnest_dssd320_voc0712.yaml",
        metavar="FILE",
        help="path to config file",
        type=str,
    )
    #parser.add_argument("--ckpt", type=str, default='E:/ZY20210320/DSSD-master/outputs/resnet101_dssd320_voc0712/model_020000.pth', help="Trained weights.")
    parser.add_argument("--ckpt", type=str, default='E:/ZY20210320/DSSD-master/outputs/resnet101_dssd320_voc_my110403/model_final.pth', help="Trained weights.")
